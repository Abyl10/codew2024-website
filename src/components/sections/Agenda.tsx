...
export const Agenda = () => {
  ...
  return (
    ...
    // <div className="w-full flex justify-center items-center phone:flex-col mt-[140px]">
    ...
    // </div>
    //   </div>
    // <span className="font-light text-[10px] text-white mt-[57px] desktop:hidden max-w-[280px]">
