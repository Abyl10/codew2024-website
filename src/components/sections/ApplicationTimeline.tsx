...
export const ApplicationTimeline = () => {
  return (
    <div className="w-full desktop:mt-[355px] h-auto flex flex-col items-center justify-center phone:mt-[280px]">
      <div className="max-w-[1750px] w-full px-[88px] phone:px-[35px]">
          ...
          <div className="flex phone:flex-col items-end gap-20 mt-16 phone:gap-8">
            {textes.map((event) => {
              return (
                ...
                >
                  <div className=" bg-gradient-to-r from-[#7F4BB2] to-[#E52D8E] py-6 px-6 font-medium text-[27px] text-white rounded-[20px] h-fit phone:text-[14px] phone:max-w-[240px]">
                    {event.text}
                  </div>
        ...
        <div className=" flex justify-center items-center mt-16 phone:hidden">
          <div className=" w-[95%] flex justify-between items-center">
            {textes.map((event) => {
              return (
                <div key={event.date} className="font-regular text-[40px] text-white">
                  {event.date}
                </div>
              );
            })}
        ...
        <div className="font-light text-white text-[27px] mt-[100px] phone:text-[10px] phone:mt-[30px]">
